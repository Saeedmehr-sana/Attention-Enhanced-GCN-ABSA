...
class Tokenizer(object):
    ...
    def sequence_to_text(self, sequence):
        return ' '.join([self.idx2word[idx] if idx in self.idx2word else '<unk>' for idx in sequence])
...
class ABSADatesetReader:
    ...
    def __read_data__(fname, tokenizer):
        ...
        # with open( "save_tokenizer.p", "wb" ) as f:
        #     print("tokenizer saved >>> save_tokenizer.p")
