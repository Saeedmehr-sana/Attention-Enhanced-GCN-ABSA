...
class BI_LSTM_GCN_SENTIC_ASPECT_BERT(nn.Module):
    """
    ...
    def __init__(self, bert, opt):
        super(BI_LSTM_GCN_SENTIC_ASPECT_BERT, self).__init__()
    ...
    def forward(self, inputs):
        ...
        # Combine dependency_graph and sentic_graph
        # Here we use element-wise multiplication as an example
